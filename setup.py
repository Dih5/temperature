"""A setuptools based setup module for temperature.
...
setup(
    ...
    description="A python module to calculate effective temperature functionals numerically",
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/Dih5/temperature',
